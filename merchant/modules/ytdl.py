...
from merchant import BOT, db, executor, LOGS, YT_USERNAME, YT_PASSWORD, DISABLE_TERRORIST_CONTENT
...
@BOT.on_message((Filters.command(commands=['get', 'audio', 'mp3']) | Filters.command(commands=['get', 'audio', 'mp3', 'mp3@videomerchantbot', 'get@videomerchantbot', 'audio@videomerchantbot'], prefixes='/')) & Filters.reply & ~Filters.edited)
